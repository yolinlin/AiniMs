...
public class DonatorCommand {
    ...
    public static class help extends CommandExecute {
        @Override
        public int execute(MapleClient c, String[] splitted) {
            c.getPlayer().dropMessage(6, ".::::::::::::::::::::::::::::::: JudoMS Donor Commands ::::::::::::::::::::::::::::::::.");
            c.getPlayer().dropMessage(6, "#heal - 治愈自己.");
            c.getPlayer().dropMessage(6, "#clear [穿戴装备 / 装备 / 消耗 / 其他 / 设置 / 特殊 / 全部] - 按你的要求清理背包垃圾.");
            c.getPlayer().dropMessage(6, "#weather - 开 / 关 当前所在地图特效.");
            c.getPlayer().dropMessage(6, "#go [map] - 前往指定地图.");
            ...
            c.getPlayer().dropMessage(6, "#say [message] - Say message to the world of JudoMS with a [Donor] tag.");
