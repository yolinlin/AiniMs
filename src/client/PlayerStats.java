...
public class PlayerStats implements Serializable {
    ...
    public transient float localmaxbasedamage, localmaxbasepvpdamage, localmaxbasepvpdamageL;
    ...
    public void recalcLocalStats(boolean first_login, MapleCharacter chra) {
        ...
        while (itera.hasNext()) {
            ...
            if (equip.getItemId() / 10000 == 166 || equip.getItemId() / 10000 == 167 && equip.getAndroid() != null && chra.getAndroid() == null) {
        ...
        localmaxhp = Math.min(99999, Math.abs(Math.max(-99999, localmaxhp_ + this.add_hp)));

        localmaxmp_ += Math.floor((percent_mp * localmaxmp_) / 100.0f);
        localmaxmp_ += chra.getTrait(MapleTraitType.sense).getLevel() * 20;
        localmaxmp = Math.min(99999, Math.abs(Math.max(-99999, localmaxmp_ + this.add_mp)));
    ...
    private void handlePassiveSkills(MapleCharacter chra) {
        ...
        switch (chra.getJob()) {
            ...
            case 231:
            case 232: {
                bx = SkillFactory.getSkill(2321003);//强化圣龙
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    TER += bx.getEffect(bof).getTERRate();
                }
                bx = SkillFactory.getSkill(2310010);//魔法爆击
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                ...
                bx = SkillFactory.getSkill(2300007);//智慧激发
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    localint_ += bx.getEffect(bof).getIntX();
                }
                bx = SkillFactory.getSkill(2310008);//神圣集中
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    passive_sharpeye_rate += bx.getEffect(bof).getCr();
                }
                bx = SkillFactory.getSkill(2321010);//魔力精通
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    magic += bx.getEffect(bof).getMagicX();
                }
                bx = SkillFactory.getSkill(2320011);//神秘瞄准术
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                ...
                bx = SkillFactory.getSkill(2100007);//智慧激发
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    localint_ += bx.getEffect(bof).getIntX();
                }
                bx = SkillFactory.getSkill(2110000);//极限魔力（火，\n毒）
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    dotTime += eff.getX();
                ...
                bx = SkillFactory.getSkill(2110001);//魔力激化
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                ...
                bx = SkillFactory.getSkill(2121003);//迷雾爆发
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    damageIncrease.put(2111003, (int) eff.getX());
                }
                bx = SkillFactory.getSkill(2121005);//火魔兽
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    TER += bx.getEffect(bof).getTERRate();
                }
                bx = SkillFactory.getSkill(2121009);//魔力精通
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    magic += bx.getEffect(bof).getMagicX();
                }
                bx = SkillFactory.getSkill(2110009);//魔法爆击
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    passive_sharpeye_rate += eff.getCr();
                ...
                bx = SkillFactory.getSkill(2120010);//神秘瞄准术
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    dam_r *= (eff.getX() * eff.getY() + 100.0) / 100.0;
                ...
                bx = SkillFactory.getSkill(2210009);//魔法爆击
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    passive_sharpeye_rate += eff.getCr();
                ...
                bx = SkillFactory.getSkill(2200007);//智慧激发
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    localint_ += bx.getEffect(bof).getIntX();
                }
                bx = SkillFactory.getSkill(2210000);//极限魔力（冰，\n雷）
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    dot += bx.getEffect(bof).getZ();
                }
                bx = SkillFactory.getSkill(2210001);//魔力激化
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    mpconPercent += eff.getX() - 100;
                ...
                bx = SkillFactory.getSkill(2221005);//冰破魔兽
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    TER += bx.getEffect(bof).getTERRate();
                }
                bx = SkillFactory.getSkill(2221009);//魔力精通
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    magic += bx.getEffect(bof).getMagicX();
                }
                bx = SkillFactory.getSkill(2220010);//神秘瞄准术
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    dam_r *= (eff.getX() * eff.getY() + 100.0) / 100.0;
                ...
                bx = SkillFactory.getSkill(2000006);//MP增加
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
            ...
            case 1211:
            case 1212: {
                bx = SkillFactory.getSkill(12110001);//魔力激化
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    mpconPercent += eff.getX() - 100;
                ...
                bx = SkillFactory.getSkill(12111004);//火魔兽
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    TER += bx.getEffect(bof).getTERRate();
                }
                bx = SkillFactory.getSkill(12000005);//MP增加
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    percent_mp += bx.getEffect(bof).getPercentMP();
                }
                bx = SkillFactory.getSkill(12110000);//魔法爆击
                bof = chra.getTotalSkillLevel(bx);
                eff = bx.getEffect(bof);
                if (bof > 0) {
                    passive_sharpeye_rate += eff.getCr();
            ...
            case 1111:
            case 1112: {
                final Skill effect = SkillFactory.getSkill(11110000); // 自我恢复
            ...
            case 2412: { // Phantom
                ...
                bx = SkillFactory.getSkill(20030206); //灵敏身手
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                ...
                bx = SkillFactory.getSkill(24111006); // 幻影突击
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    damageIncrease.put(24101002, eff.getDAMRate());
                }
                bx = SkillFactory.getSkill(24121003); // 暮光祝福
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    damageIncrease.put(24111006, eff.getDAMRate());
                }
                bx = SkillFactory.getSkill(24120006); // 手杖专家
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    passive_sharpeye_min_percent += eff.getCriticalMin();
                }
                bx = SkillFactory.getSkill(24001002); // 迅捷幻影
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                ...
                bx = SkillFactory.getSkill(24000003); // 快速逃避
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    dodgeChance += eff.getER();
                }
                bx = SkillFactory.getSkill(24100006); // 超级幸运星
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    localluk += eff.getLukX();
                }
                bx = SkillFactory.getSkill(24110007); // 敏锐直觉
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    passive_sharpeye_rate += eff.getCr();
                }
                bx = SkillFactory.getSkill(24111002); // 神秘的运气
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    localluk += eff.getLukX();
            ...
            case 531:
            case 532:
                bx = SkillFactory.getSkill(5300004);//致命炮火
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    this.passive_sharpeye_rate += (short) (bx.getEffect(bof).getCr());
                    this.passive_sharpeye_min_percent += bx.getEffect(bof).getCriticalMin();
                    return;
                }
                bx = SkillFactory.getSkill(5320009);//极限燃烧弹
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    dam_r *= (bx.getEffect(bof).getDAMRate() + 100.0) / 100.0;
                    bossdam_r *= (bx.getEffect(bof).getDAMRate() + 100.0) / 100.0;
                    ignoreTargetDEF += bx.getEffect(bof).getIgnoreMob();
                }
                bx = SkillFactory.getSkill(5311001);//猴子超级炸弹
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    damageIncrease.put(5301001, (int) bx.getEffect(bof).getDAMRate());
                }
                bx = SkillFactory.getSkill(5310007);//生命强化
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                ...
                bx = SkillFactory.getSkill(5310006);//火炮强化
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
            ...
            case 3112://Demon slayer
                bx = SkillFactory.getSkill(31100006); // 愤怒
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    this.passive_sharpeye_rate += (short) (bx.getEffect(bof).getCr());
                ...
                bx = SkillFactory.getSkill(31100007);//恶魔血月斩1次强化
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    damageIncrease.put(31000004, (int) eff.getDAMRate());
                }
                bx = SkillFactory.getSkill(31110008);//精气防护
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                ...
                bx = SkillFactory.getSkill(31110009);//极限精气吸收
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    mpRecover += 1;
                ...
                bx = SkillFactory.getSkill(31121006);//黑暗束缚
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    ignoreTargetDEF += bx.getEffect(bof).getIgnoreMob();
                }
                bx = SkillFactory.getSkill(31120011);//恶魔血月斩最终强化
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                ...
                bx = SkillFactory.getSkill(31120008);//进阶精准武器
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    watk += eff.getAttackX();
                ...
                bx = SkillFactory.getSkill(31110006);//邪恶拷问
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    dam_r *= (eff.getX() + 100.0) / 100.0;
                    bossdam_r *= (eff.getX() + 100.0) / 100.0;
                    this.passive_sharpeye_rate += (short) (bx.getEffect(bof).getY());
                }
                ...
                bx = SkillFactory.getSkill(31120009);//皮肤硬化
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    percent_wdef += bx.getEffect(bof).getT();
                }
                bx = SkillFactory.getSkill(30010112);//恶魔之怒
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                ...
                bx = SkillFactory.getSkill(30010111);//死亡诅咒
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
            ...
            case 1511:
            case 1512: {
                bx = SkillFactory.getSkill(15110009);//致命狂热
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    this.passive_sharpeye_rate += (short) (bx.getEffect(bof).getCr());
                    passive_sharpeye_percent += bx.getEffect(bof).getCriticalMin();
                    this.passive_sharpeye_min_percent += bx.getEffect(bof).getCriticalMin();
                    this.bossdam_r += bx.getEffect(bof).getProb();
                    return;
                }
                bx = SkillFactory.getSkill(15000006);//必杀拳
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    this.passive_sharpeye_rate += (short) (bx.getEffect(bof).getCr());
                    this.passive_sharpeye_min_percent += bx.getEffect(bof).getCriticalMin();
                ...
                bx = SkillFactory.getSkill(15000008);//HP增加
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    percent_hp += bx.getEffect(bof).getPercentHP();
                }
            ...
            case 571:
            case 572: { // Jett
                bx = SkillFactory.getSkill(5710004); // 侠义韧性
                    bof = chra.getTotalSkillLevel(bx);
                    if (bof > 0) {
                        eff = bx.getEffect(bof);
                        percent_wdef += eff.getWDEFRate();
                ...
                bx = SkillFactory.getSkill(5080000); // 侠客行
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                ...
                bx = SkillFactory.getSkill(5080004); // 狮子的力量
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    passive_sharpeye_rate += eff.getCr();
                    ...
                    bx = SkillFactory.getSkill(5700003); // 物理训练
                    bof = chra.getTotalSkillLevel(bx);
                    if (bof > 0) {
                        eff = bx.getEffect(bof);
                    ...
                    final Skill effect = SkillFactory.getSkill(5700005); // 侠士的忍耐
                    final int lvl = chra.getSkillLevel(effect);
                        if (lvl > 0) {
                    ...
                    bx = SkillFactory.getSkill(5710005); // 气运丹田
                    bof = chra.getTotalSkillLevel(bx);
                    if (bof > 0) {
                        eff = bx.getEffect(bof);
                        passive_sharpeye_rate += eff.getCr();
                    ...
                    bx = SkillFactory.getSkill(5720008); // 狂热
                    bof = chra.getTotalSkillLevel(bx);
                    if (bof > 0) {
                        eff = bx.getEffect(bof);
                        passive_sharpeye_rate += eff.getCr();
            ...
            case 422: { // Shadower
                bx = SkillFactory.getSkill(4100001); // 强力投掷
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    passive_sharpeye_rate += (short) (bx.getEffect(bof).getProb());
                    passive_sharpeye_min_percent += bx.getEffect(bof).getCriticalMin();
                }
                bx = SkillFactory.getSkill(4110008); // 永恒黑暗
                    bof = chra.getTotalSkillLevel(bx);
                    if (bof > 0) {
                        eff = bx.getEffect(bof);
                ...
                bx = SkillFactory.getSkill(4110012); // 娴熟飞镖术
                    bof = chra.getTotalSkillLevel(bx);
                    if (bof > 0) {
                        eff = bx.getEffect(bof);
                    ...
                    bx = SkillFactory.getSkill(4110014);//药品吸收
                    bof = chra.getTotalSkillLevel(bx);
                    if (bof > 0) {
                        eff = bx.getEffect(bof);
                        RecoveryUP += eff.getX() - 100;
                    }
                    bx = SkillFactory.getSkill(4121014); // 黑暗祝福
                    bof = chra.getTotalSkillLevel(bx);
                    if (bof > 0) {
                        eff = bx.getEffect(bof);
                        ignoreTargetDEF += eff.getIgnoreMob();
                    }
                bx = SkillFactory.getSkill(4001005); // 轻功
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    speed += eff.getSpeedMax();
                }
                bx = SkillFactory.getSkill(4210013); // 永恒黑暗
                    bof = chra.getTotalSkillLevel(bx);
                    if (bof > 0) {
                        eff = bx.getEffect(bof);
                        percent_hp += eff.getPercentHP();
                    ...
                    bx = SkillFactory.getSkill(4221013); // 侠盗本能
                    bof = chra.getTotalSkillLevel(bx);
                    if (bof > 0) {
                        eff = bx.getEffect(bof);
                        ignoreTargetDEF += eff.getIgnoreMob();
                    }
                    bx = SkillFactory.getSkill(4221007); // 一出双击
                    bof = chra.getTotalSkillLevel(bx);
                    if (bof > 0) {
                        eff = bx.getEffect(bof);
                        ...
                        damageIncrease.put(4211011, eff.getDAMRate());
                    }
                bx = SkillFactory.getSkill(4210000);//盾防精通
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
            ...
            case 434: { // Blade Master
                ...
                bx = SkillFactory.getSkill(4301003); // 暗影轻功
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    speed += eff.getSpeedMax();
                }
                bx = SkillFactory.getSkill(4331000);//血雨腥风
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    damageIncrease.put(4301004, (int) eff.getDAMRate());
                    damageIncrease.put(4321006, (int) eff.getDAMRate());
                }
                bx = SkillFactory.getSkill(4340010);//锋利
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    this.passive_sharpeye_rate += (short) (bx.getEffect(bof).getProb());
                    this.passive_sharpeye_min_percent += bx.getEffect(bof).getCriticalMin();
                    return;
                }
                bx = SkillFactory.getSkill(4341006);//傀儡召唤
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    percent_wdef += eff.getWDEFRate();
            ...
            case 131:
            case 132: {
                bx = SkillFactory.getSkill(1310009);//龙之审判
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    passive_sharpeye_rate += eff.getCr();
                ...
                bx = SkillFactory.getSkill(1220006);//守护之神
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                ...
                bx = SkillFactory.getSkill(1120013);//进阶终极攻击
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    watk += eff.getAttackX();
                ...
                bx = SkillFactory.getSkill(1110000);//自我恢复
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                ...
                bx = SkillFactory.getSkill(1110009);//乘胜追击
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                ...
                bx = SkillFactory.getSkill(1220005);//阿基里斯
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    percent_wdef += bx.getEffect(bof).getT();
                }
                bx = SkillFactory.getSkill(1220010);//万佛归一破
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    trueMastery += bx.getEffect(bof).getMastery();
                }
                bx = SkillFactory.getSkill(1310000);//魔法抗性
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
            ...
            case 3511:
            case 3512: {
                bx = SkillFactory.getSkill(35110014);//精准机械拳
                bof = chra.getTotalSkillLevel(bx);
                ...
                bx = SkillFactory.getSkill(35121006);//卫星防护
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) { // Satellite
                    eff = bx.getEffect(bof);
                ...
                bx = SkillFactory.getSkill(35120001);//机器人精通
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) { // Satellite
                    eff = bx.getEffect(bof);
                ...
                bx = SkillFactory.getSkill(35100000);//机械精通
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    watk += bx.getEffect(bof).getAttackX();
                    trueMastery += bx.getEffect(bof).getMastery();
                ...
                bx = SkillFactory.getSkill(35120000);//终极机甲
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    trueMastery += bx.getEffect(bof).getMastery();
                }
            ...
            case 3211:
            case 3212: {
                bx = SkillFactory.getSkill(32100006);//精准长杖
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                ...
                bx = SkillFactory.getSkill(32121004);//黑暗创世
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    damageIncrease.put(32111003, (int) bx.getEffect(bof).getDAMRate());
                }
                bx = SkillFactory.getSkill(32110000);//进阶蓝色灵气
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    ASR += bx.getEffect(bof).getASRRate();
                    TER += bx.getEffect(bof).getTERRate();
                }
                bx = SkillFactory.getSkill(32110001);//战斗精通
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    dam_r *= (eff.getDAMRate() + 100.0) / 100.0;
                ...
                bx = SkillFactory.getSkill(32120000);//进阶黑暗灵气
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    magic += bx.getEffect(bof).getMagicX();
                }
                bx = SkillFactory.getSkill(32120001);//进阶黄色灵气
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    dodgeChance += bx.getEffect(bof).getER();
                }
                bx = SkillFactory.getSkill(32120009);//活力激化
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    percent_hp += bx.getEffect(bof).getPercentHP();
                    percent_mp += bx.getEffect(bof).getPercentMP();
            ...
            case 3312: {// Wild hunter
                bx = SkillFactory.getSkill(33120000);//神弩手
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    watk += eff.getX();
                ...
                bx = SkillFactory.getSkill(33110000);//骑宠精通
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    dam_r *= (eff.getDamage() + 100.0) / 100.0;
                ...
                bx = SkillFactory.getSkill(33120010);//野性本能
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    ignoreTargetDEF += eff.getIgnoreMob();
            ...
            case 2217:
            case 2218: {
                bx = SkillFactory.getSkill(22140000);//魔法爆击
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    this.passive_sharpeye_rate += (short) (bx.getEffect(bof).getProb());
                    this.passive_sharpeye_min_percent += bx.getEffect(bof).getCriticalMin();
                ...
                bx = SkillFactory.getSkill(22160000);//龙的愤怒
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    dam_r *= (eff.getDamage() + 100.0) / 100.0;
                ...
                bx = SkillFactory.getSkill(22170001); // 魔法精通
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    magic += eff.getX();
        ...
        bx = SkillFactory.getSkill(80000000);//海盗祝福
        ...
        bx = SkillFactory.getSkill(80000001);//恶魔之怒
        bof = chra.getSkillLevel(bx);
        if (bof > 0) {
            eff = bx.getEffect(bof);
            bossdam_r *= eff.getBossDamage();
        }
        bx = SkillFactory.getSkill(80001040);//精灵的祝福
        bof = chra.getSkillLevel(bx);
        if (bof > 0) {
        ...
        switch (chra.getJob()) {
            ...
            case 2311:
            case 2312: {
                bx = SkillFactory.getSkill(20021110);//精灵的祝福
                bof = chra.getSkillLevel(bx);
                if (bof > 0) {
                    expBuff *= (bx.getEffect(bof).getEXPRate() + 100.0) / 100.0;
                }
                bx = SkillFactory.getSkill(20020112);//王者资格
                bof = chra.getSkillLevel(bx);
                if (bof > 0) {
                    chra.getTrait(MapleTraitType.charm).addLocalExp(GameConstants.getTraitExpNeededForLevel(30));
                }
                bx = SkillFactory.getSkill(23000001);//潜力激发
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    dodgeChance += bx.getEffect(bof).getER();
                }
                bx = SkillFactory.getSkill(23100008);//物理训练
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    localstr += eff.getStrX();
                ...
                bx = SkillFactory.getSkill(23121004);//古老意志
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    dodgeChance += bx.getEffect(bof).getProb();
                }
                bx = SkillFactory.getSkill(23120009);//双弩枪专家
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
            ...
            case 1311:
            case 1312: {
                bx = SkillFactory.getSkill(13000000);//强力箭
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    this.passive_sharpeye_rate += (short) (bx.getEffect(bof).getProb());
                    this.passive_sharpeye_min_percent += bx.getEffect(bof).getCriticalMin();
                ...
                bx = SkillFactory.getSkill(13000001);//弓箭手精通
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    speed += bx.getEffect(bof).getU(); 
                    defRange += bx.getEffect(bof).getRange();
                }
                bx = SkillFactory.getSkill(13110008);//闪避
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    dodgeChance += bx.getEffect(bof).getER();
                }
                bx = SkillFactory.getSkill(13110003);//神箭手
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    trueMastery += eff.getMastery();
            ...
            case 322:
            case 312: {
                bx = SkillFactory.getSkill(3000001);//强力箭
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    passive_sharpeye_rate += eff.getProb();
                }
                bx = SkillFactory.getSkill(3000002);//弓箭手精通
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    defRange += bx.getEffect(bof).getRange();
                }
                bx = SkillFactory.getSkill(3200006);//物理训练
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    localstr += eff.getStrX();
                ...
                bx = SkillFactory.getSkill(3210007);//闪避
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    dodgeChance += bx.getEffect(bof).getER();
                }
                bx = SkillFactory.getSkill(3200000);//精准弩
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    trueMastery += eff.getMastery();
                }
                bx = SkillFactory.getSkill(3220009);//射术精修
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    ignoreTargetDEF += eff.getIgnoreMob();
                }
                bx = SkillFactory.getSkill(3220005);//精神连接：火凤凰
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0 && chra.getBuffedValue(MapleBuffStat.SPIRIT_LINK) != null) {
                    eff = bx.getEffect(bof);
                    percent_hp += eff.getX();
                    percent_wdef += eff.getY();
                    TER += eff.getTERRate();
                    percent_mdef += eff.getZ();
                    dam_r *= (eff.getDamage() + 100.0) / 100.0;
                    bossdam_r *= (eff.getDamage() + 100.0) / 100.0;
                }
                bx = SkillFactory.getSkill(3220004);//神弩手
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    watk += eff.getX();
                ...
                bx = SkillFactory.getSkill(3100006);// 物理训练
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    localstr += eff.getStrX();
                ...
                bx = SkillFactory.getSkill(3110007);//闪避
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    dodgeChance += bx.getEffect(bof).getER();
                }
                bx = SkillFactory.getSkill(3120005);//神箭手
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    trueMastery += eff.getMastery();
                ...
                bx = SkillFactory.getSkill(3120011);//射术精修
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    ignoreTargetDEF += eff.getIgnoreMob();
                }
                bx = SkillFactory.getSkill(3120006);//精神连接：火凤凰
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0 && chra.getBuffedValue(MapleBuffStat.SPIRIT_LINK) != null) {
                    eff = bx.getEffect(bof);
                    percent_hp += eff.getX();
            ...
            case 2111:
            case 2112: { // Aran
                bx = SkillFactory.getSkill(21110000);//爆击强化
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    this.passive_sharpeye_rate += (short) ((bx.getEffect(bof).getX() * bx.getEffect(bof).getY()) + bx.getEffect(bof).getCr());
                    return;
                }
                bx = SkillFactory.getSkill(21120001);//攻击策略
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    watk += eff.getX();
                ...
                bx = SkillFactory.getSkill(21100008);// 物理训练
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    localstr += eff.getStrX();
                ...
                bx = SkillFactory.getSkill(21101006);//冰雪矛
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    dam_r *= (eff.getDAMRate() + 100.0) / 100.0;
                ...
                bx = SkillFactory.getSkill(21110010);//分裂攻击
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    ignoreTargetDEF += bx.getEffect(bof).getIgnoreMob();
                ...
                bx = SkillFactory.getSkill(21110002);//全力挥击
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    damageIncrease.put(21000004, bx.getEffect(bof).getW());
                }
                bx = SkillFactory.getSkill(21120002);//战神之舞
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    damageIncrease.put(21100007, bx.getEffect(bof).getZ());
                }
                bx = SkillFactory.getSkill(21120011);//迅捷移动
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
            ...
            case 521:
            case 522: {
                bx = SkillFactory.getSkill(5000007);//致命咆哮
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    this.passive_sharpeye_rate += (short) bx.getEffect(bof).getCr();
                    this.passive_sharpeye_min_percent += bx.getEffect(bof).getCriticalMin();
                }
                bx = SkillFactory.getSkill(5110000);//迷惑攻击
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    this.passive_sharpeye_rate += (short) bx.getEffect(bof).getCr();
                    this.passive_sharpeye_min_percent += bx.getEffect(bof).getCriticalMin();
                }
                bx = SkillFactory.getSkill(5100013);// 忍耐
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    shouldHealHP += (bx.getEffect(bof).getX() * localmaxhp) / 100;
                    hpRecoverTime = bx.getEffect(bof).getY();
                    shouldHealMP += (bx.getEffect(bof).getX() * localmaxmp) / 100;
                    mpRecoverTime = bx.getEffect(bof).getY();
                }
                bx = SkillFactory.getSkill(5100009);//HP增加
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    percent_hp += bx.getEffect(bof).getPercentHP();
                }
                bx = SkillFactory.getSkill(5110011);//致命狂热
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    this.passive_sharpeye_rate += (short) (bx.getEffect(bof).getCr());
                    this.passive_sharpeye_min_percent += bx.getEffect(bof).getCriticalMin();
                ...
                bx = SkillFactory.getSkill(5200007);//强力弹
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    this.passive_sharpeye_rate += (short) (bx.getEffect(bof).getCr());
                    this.passive_sharpeye_min_percent += bx.getEffect(bof).getCriticalMin();
                ...
                bx = SkillFactory.getSkill(5121015);//蛇拳
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                ...
                bx = SkillFactory.getSkill(5210012); // 侠义韧性
                    bof = chra.getTotalSkillLevel(bx);
                    if (bof > 0) {
                        eff = bx.getEffect(bof);
                        percent_wdef += eff.getWDEFRate();
                    ...
                    bx = SkillFactory.getSkill(5210013);//合金子弹
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    this.passive_sharpeye_rate += (short) (bx.getEffect(bof).getCr());
                ...
                bx = SkillFactory.getSkill(5220001);//属性强化
                bof = chra.getTotalSkillLevel(bx);
            ...
            case 1411:
            case 1412: {
                bx = SkillFactory.getSkill(14100001);//强力投掷
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    this.passive_sharpeye_rate += (short) (bx.getEffect(bof).getProb());
                    this.passive_sharpeye_min_percent += bx.getEffect(bof).getCriticalMin();
                ...
                bx = SkillFactory.getSkill(14110003);//药剂精通
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    RecoveryUP += eff.getX() - 100;
                ...
                bx = SkillFactory.getSkill(14110009); // 永恒黑暗
                    bof = chra.getTotalSkillLevel(bx);
                    if (bof > 0) {
                        eff = bx.getEffect(bof);
                        percent_hp += eff.getPercentHP();
                ...
                bx = SkillFactory.getSkill(14000001);//远程暗器
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    defRange += bx.getEffect(bof).getRange();
                }
            ...
            case 5112: { // Mihile 4
                ...
                bx = SkillFactory.getSkill(51120002); // 进阶终极攻击
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    damageIncrease.put(51100002, (int) eff.getDamage());
                }
                bx = SkillFactory.getSkill(51110000); // 自我恢复
                 bof = chra.getTotalSkillLevel(bx);
                 if (bof > 0) {
                 eff = bx.getEffect(bof);
                shouldHealHP += eff.getHp();
                ...
                bx = SkillFactory.getSkill(51110001); // 专注
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    localstr += eff.getStrX();
                }
                bx = SkillFactory.getSkill(51110002); // 灵魂突击
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    dam_r += (eff.getX() + 100.0) / 100.0;
                ...
                bx = SkillFactory.getSkill(51120000); // 战斗精通
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    ignoreTargetDEF += eff.getIgnoreMob();
                }
                bx = SkillFactory.getSkill(51120001); // 进阶精准剑
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    eff = bx.getEffect(bof);
                    watk += bx.getEffect(bof).getX();
                ...
                bx = SkillFactory.getSkill(51120003); // 进阶灵魂盾
                bof = chra.getTotalSkillLevel(bx);
                if (bof > 0) {
                    percent_wdef += bx.getEffect(bof).getT();
                }
            ...
            bx = SkillFactory.getSkill(30000002);//效率提升
            bof = chra.getTotalSkillLevel(bx);
            if (bof > 0) {
    ...
    private void handleBuffStats(MapleCharacter chra) {
        ...
        if (eff != null && eff.getSourceId() == 33001001) { // 美洲豹骑士
            passive_sharpeye_rate += eff.getW();
            percent_hp += eff.getZ();
        }
        if (eff != null && eff.getSourceId() == 35001002) { // 金属机甲：原型
            speed += 20;
            maxhp += eff.getMaxHpX();
            maxmp += eff.getMaxMpX();
        }
