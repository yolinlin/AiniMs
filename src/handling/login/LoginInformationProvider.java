...
public class LoginInformationProvider {
    ...
    public enum JobType {
        ...
        UltimateAdventurer(-1, "Ultimate", 0, 100000000),//100000000
        Resistance(0, "Resistance", 3000, 931000000),//931000000
        Adventurer(1, "", 0, 0),
        Cygnus(2, "Premium", 1000, 130030000),//130030000
        Aran(3, "Orient", 2000, 914000000),//914000000
        Evan(4, "Evan", 2001, 900090000),//900090000
        Mercedes(5, "", 2002, 910150000),//910150000
        Demon(6, "", 3001, 931050310),//931050310
        Phantom(7, "", 2003, 915000000),//915000000
        DualBlade(8, "", 0, 103050900),//103050900
        Mihile(9, "", 5000, 913070000),//913070000
        Luminous(10, "", 2004, -1),
        Kaiser(11, "", 6000, -1),
        AngelicBuster(12, "", 6001, -1),
        Demon_Avenger(13, "", 3001, -1),
        Xenon(14, "", 3002, -1),
        Jett(15, "", 0, 552000010);//10000 
