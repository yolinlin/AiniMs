...
public class DatabaseConnection {
    ...
    private static final class ThreadLocalConnection extends ThreadLocal<Connection> {
        ...
        protected final Connection initialValue() {
            ...
            try {
                final Connection con = DriverManager.getConnection("jdbc:mysql://localhost:" + ServerConstants.SQL_PORT + "/" + ServerConstants.SQL_DATABASE + "?autoReconnect=true&characterEncoding=GBK", ServerConstants.SQL_USER,ServerConstants.SQL_PASSWORD);
