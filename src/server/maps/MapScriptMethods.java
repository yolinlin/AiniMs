...
public class MapScriptMethods {
    ...
    /*            if (c.getPlayer().getLevel() < 10) {
                ...
                if(c.getPlayer().getLevel() < 10) {
                    c.getPlayer().gainExp(15, true, true, true);
                    c.getPlayer().gainExp(34, true, true, true);
                    c.getPlayer().gainExp(57, true, true, true);
                    c.getPlayer().gainExp(92, true, true, true);
                    c.getPlayer().gainExp(135, true, true, true);
                    c.getPlayer().gainExp(372, true, true, true);
                    c.getPlayer().gainExp(560, true, true, true);
                    c.getPlayer().gainExp(840, true, true, true);
                    c.getPlayer().gainExp(1242, true, true, true);
                    c.getPlayer().changeJob((short) 2400);
                    c.getPlayer().gainExp(1001, true, true, true);
                    c.getPlayer().resetStats(4, 4, 4, 35); 
                    c.getPlayer().gainAp((short) 23);                    
                    c.getPlayer().gainItem(2000005, 50);
                    c.getPlayer().gainItem(1142375, 1);  
                }
                break;
            }
            case go10000:
