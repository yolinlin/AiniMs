...
public class MapleMonsterStats {
    ...
    private long hp;
    private int jingying, id, exp, mp, removeAfter, buffToGive, fixedDamage, selfDestruction_hp, dropItemPeriod, point, eva, acc, PhysicalAttack, MagicAttack, speed, partyBonusR, pushed;
	...
	public MapleMonsterStats(int id) {
        ...
        public void setjingying(int jingying) {
        this.jingying = jingying;
    }
    
    public int getjingying() {
        return jingying;
    }
