...
if (mode == 1) 
   ...
   status--;
    if (status == 0) { 
	cm.sendSimple("Hi #r#h ##k, I am the Starter NPC for JudoMS.\r\ You need 15 Red snail shells to get out of here\r\n#b#L1#Let me out of here#l");
	}
	if (selection == 1) {
	if (cm.haveItem(4000016, 15)) {
		...
		cm.gainExp(800);
        cm.gainMeso(1000000);
                	cm.msiMessage("Everyone, Please Welcome "+cm.getPlayer().getName()+", the newest player of JudoMS.");

		cm.sendOk("Enjoy JudoMS! Type @help for all our commands.");
		cm.warp(910000000, 0);
		cm.dispose();
	} else {
