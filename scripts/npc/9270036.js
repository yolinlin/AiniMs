...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (selection == 1) {
            ...
            cm.askAvatar("我能彻底给你的头发变个样。你是准备改变一下了吧？有#b万能会员卡#k的话，我就可以帮你打理好。选择一下你喜欢的发型吧！", hair_Colo_new);
        } else if (selection == 2) {
            ...
            cm.askAvatar("我能彻底给你的头发变个颜色。你是准备改变一下了吧？有#b万能会员卡#k的话，我就可以帮你打理好。选择一下你喜欢的发型吧！", hair_Colo_new);
        }
    } else if (status == 2) {
        if (beauty == 1) {
