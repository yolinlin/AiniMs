...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        if (cm.getAndroidStat("GENDER") == 0) {
            if (selection == 0) {
                beauty = 1;
                cm.sendAStyle("您想将安卓更换成什么样的皮肤呢？请挑选一下～", skin);
            } else if (selection == 1) {
                beauty = 2;
                hairnew = Array();
                ...
                cm.sendAStyle("我可以帮您的安卓换成全新的发型。您厌倦了现在的安卓发型了吗？只要您有#b万能会员卡#k，我就可以帮您的安卓更换发型。请慢慢挑选自己喜欢的发型～", hairnew);
            } else if (selection == 2) {
                beauty = 3;
                haircolor = Array();
                ...
                cm.sendAStyle("我们可以为您的安卓改变头发的颜色。是不是已经厌倦了安卓头发的颜色啊？如果您有#b万能会员卡#k，我就可以给您安卓染发，慢慢挑选您喜欢的颜色吧！", haircolor);
            } else if (selection == 3) {
                beauty = 4;
                facenew = Array();
                ...
                cm.sendAStyle("可以让您的安卓面容焕然一新…不想让您的安卓面容变一变吗？ 只需要#b万能会员卡#k就可以给您的安卓做整形手术.怎么样~慢慢挑选一下您想要的面容~", facenew);
            } else if (selection == 4) {
                beauty = 5;
                ...
                cm.sendAStyle("请选择您喜欢的眼睛颜色吧.", colors);
            }
        } else {
            if (selection == 0) {
                beauty = 1;
