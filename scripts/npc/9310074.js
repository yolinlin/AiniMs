...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendSimple("我是兑换NPC，你目前拥有点卷: "+ cm.getPlayer().getCSPoints(2) + "#b\r\n#L0#用点卷兑换惊人的神奇魔方#l");
    } else if (status == 1) {
    ...
    World.Broadcast.broadcastSmega(CWvsContext.serverNotice(6, "玩家"+ cm.getName() +"用"+ selection * jiage +"点券兑换了"+ selection +"个惊人的神奇魔方!"));
		cm.sendOk("兑换成功!");
	    }
	}
        cm.dispose();
